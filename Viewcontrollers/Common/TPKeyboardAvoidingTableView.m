...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if ([_touchedDelegate conformsToProtocol:@protocol(TouchTableViewDelegate)] &&
        [_touchedDelegate respondsToSelector:@selector(tableView:touchesBegan:withEvent:)])
    {
        [_touchedDelegate tableView:self touchesBegan:touches withEvent:event];
    }
    else
    {
...
- (void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if ([_touchedDelegate conformsToProtocol:@protocol(TouchTableViewDelegate)] &&
        [_touchedDelegate respondsToSelector:@selector(tableView:touchesMoved:withEvent:)])
    {
        [_touchedDelegate tableView:self touchesMoved:touches withEvent:event];
    }
}
