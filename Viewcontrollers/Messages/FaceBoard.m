...
//        {
//            _faceMap = [[NSDictionary dictionaryWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"_expression_cn"ofType:@"plist"]] retain];
//        }
//        else
//        {
//            _faceMap = [[NSDictionary dictionaryWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"_expression_en" ofType:@"plist"]] retain];
//        }
//        [[NSUserDefaults standardUserDefaults] setObject:_faceMap forKey:@"FaceMap"];
        ...
        faceView.contentSize = CGSizeMake((FACE_COUNT_ALL / FACE_COUNT_PAGE) * 320, 190);
        ...
        facePageControl.numberOfPages = FACE_COUNT_ALL / FACE_COUNT_PAGE;
        ...
        if ( stringLength >= FACE_NAME_LEN )
        {
            ...
            if ( range.location == 0 )
            {
                string = [inputString substringToIndex:
                          [inputString rangeOfString:FACE_NAME_HEAD options:NSBackwardsSearch].location];
            }
            else
            {
